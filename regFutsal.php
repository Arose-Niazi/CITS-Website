    ...
    <div class="container main-body">
        <div class="row">
            <div id="act" class="col-md-4">
                ...
                <div id="act">
                    <div data-aos="fade-right" data-aos-duration="600"> <a class="events" id="cod" href='regCOD.php' class="events class">Call Of Duty</a></p></div>
                    <div data-aos="fade-right" data-aos-duration="700"> <a class="events" id="fifa" href='regFifa.php' class="events">FIFA 2020</a></p></div>
                    <div data-aos="fade-right" data-aos-duration="800"> <a class="events" id="treasureHunt" href='regTreasure.php' class="events">Treasure Hunt</a></p></div>
                    <div data-aos="fade-right" data-aos-duration="900"> <a class="events" id="futsal" href='regFutsal.php' class="events">Futsal</a></p></div>
                    <div data-aos="fade-right" data-aos-duration="1000"> <a class="events" id="party" href='regParty.php' class="events">Welcome Party</a></p></div>
                </div>
